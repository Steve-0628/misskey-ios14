	...
	<div class="main">
		...
		<div class="contents">
			...
			<div v-if="!root" class="powered-by">
				<b><MkA to="/">{{ host }}</MkA></b>
				<small>Powered by <a href="https://github.com/Steve-0628/misskey" target="_blank">Misskey</a></small>
			</div>
		</div>
	</div>
